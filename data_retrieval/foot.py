...
for i in range(1,21):
	driver.get("https://www.flipkart.com/womens-footwear/pr?sid=osp%2Ciko&otracker=nmenu_sub_Women_0_Footwear&page=" +str(i))
...
df.to_csv('women_footwear.csv', index=False, encoding='utf-8')